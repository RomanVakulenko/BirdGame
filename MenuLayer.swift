...
//  Bird
//
//  Created by Roman Vakulenko on 14.09.2022.
//
...
class MenuLayer: SKSpriteNode {
    ...
    func display(message: String, score: Int?) {
        ...
        if let scoreToDisplay = score {//если очки были переданы, то
            let scoreString = String(format: "Очки:%04d", scoreToDisplay)//создаем текст с очками
